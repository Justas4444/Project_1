...
def train_NDX():
    # Load the historical stock price data from "NDX.csv"
    data = pd.read_csv("csv/NDX.csv")
    ...
    model_open.save("trained_models/NDX_model_open.h5")
    model_high.save("trained_models/NDX_model_high.h5")
    model_low.save("trained_models/NDX_model_low.h5")
    model_close.save("trained_models/NDX_model_close.h5")
    model_adj_close.save("trained_models/NDX_model_adj_close.h5")
    model_volume.save("trained_models/NDX_model_volume.h5")
    model_interest_rate.save("trained_models/NDX_model_interest_rate.h5")
...
def predict_NDX():
    ...
    #Load models
    model_open = tf.keras.models.load_model("trained_models/NDX_model_open.h5")
    model_high = tf.keras.models.load_model("trained_models/NDX_model_high.h5")
    model_low = tf.keras.models.load_model("trained_models/NDX_model_low.h5")
    model_close = tf.keras.models.load_model("trained_models/NDX_model_close.h5")
    model_adj_close = tf.keras.models.load_model("trained_models/NDX_model_adj_close.h5")
    model_volume = tf.keras.models.load_model("trained_models/NDX_model_volume.h5")
    model_interest_rate = tf.keras.models.load_model("trained_models/NDX_model_interest_rate.h5")
